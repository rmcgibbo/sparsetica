...
We note that others have also defined a reaction coordinate consistent with the intuitive mathematical properties specified in Section~

 In this formulation, a map is created from sampled points in phase space by utilizing a geometric distance metric, where points that are close geometrically are expected to correspond to kinetically similar conformations.


{\color{red}Another reaction coordinate definition worth mentioning is the second eigenfunction (or the subset of leading eigenfunctions) estimated by diffusion maps.\cite{nadler2006diffusion} 
% TODO
A major advantage 
...
\hl{reword} We note that others have also used the term reaction coordinate for these eigenfunctions.\cite{nadler2006diffusion, rohrdanz2011determination, Boninsegna_JCTC15}
...
\hl{move to appendix etc, for pedagogical purposes}
